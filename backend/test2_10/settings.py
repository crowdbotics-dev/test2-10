"""
Django settings for test2_10 project.
...
WSGI_APPLICATION = 'test2_10.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test2_10 API",
    "DESCRIPTION": "API documentation for test2_10 App",
    "VERSION": "v1",
}
